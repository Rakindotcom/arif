...
export default function About() {
  const expertise = [
    ...
    { title: 'শিক্ষক', desc: 'সম্পর্ক ও বিবাহ শিক্ষা কোর্স' }
  ];
            ...
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg leading-relaxed mb-6">
                  ...
                  ঢাকা বিশ্ববিদ্যালয়ে অধ্যয়নের সময় থেকেই আমি মানব মনোবিজ্ঞান এবং 
                  ইসলামিক জ্ঞানের সমন্বয়ে কাজ করার প্রতি আগ্রহী হয়ে উঠি।
                </p>
                ...
                <p className="text-lg leading-relaxed mb-6">
                  আমি নিড (Need) এর সহ-প্রতিষ্ঠাতা, যা একটি সম্পর্ক ও বিবাহ শিক্ষা কোর্স প্ল্যাটফর্ম। 
                  এই প্ল্যাটফর্মের মাধ্যমে আমরা অনলাইন কোর্স, রেকর্ডেড ক্লাস এবং PDF গাইড প্রদান করে 
                  ৯৩,০০০+ মানুষকে দাম্পত্য জীবন উন্নত করতে এবং সুস্থ সম্পর্ক গড়তে সাহায্য করছি।
                </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-8 rounded-2xl mb-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-4">সম্পর্ক ও বিবাহ শিক্ষা কোর্স প্ল্যাটফর্ম</h3>
                    <p className="text-lg leading-relaxed mb-4">
                      নিড (Need) একটি অনলাইন কোর্স প্ল্যাটফর্ম যা সম্পর্ক এবং বিবাহ সম্পর্কিত 
                      ব্যবহারিক জ্ঞান প্রদান করে। আমরা বাংলাদেশের মানুষদের জন্য বিশেষভাবে 
                      ডিজাইন করা রেকর্ডেড কোর্স, লাইভ ক্লাস এবং PDF গাইড তৈরি করি।
                    </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
                  ...
                  <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>বিবাহ পূর্ব প্রস্তুতি</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>দাম্পত্য জীবন উন্নয়ন</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>দ্বন্দ্ব সমাধান কৌশল</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>তালাক প্রতিরোধ</span>
                    </li>
                  </ul>
                </div>
              </div>
